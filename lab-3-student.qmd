...
There are 30 rows and 15 columns of data in the chunk above.
...
The data types consist of characters, doubles, and dates.
<!-- Run the commented code in the load-data chunk to address this question!  -->
...
ggplot(data = surveys,
  ...
  labs(x = "Weight",
       ...
       title = "Scatterplots of Rodent Hindfoot Lengths by their Weight") +
...
-   include your source code (`code-tools: true`) **When I included it kept giving errors for rendering
-   include all your code and output (`echo: true`) **When I included it kept giving errors for rendering
